...
It is usually rainy in fall so there will be raindrops and ripples on our water surface. 
...
I simulated the splash based on the Newton's theory of gravity, the water drop particles will move towards random direction an fall due to gravity. 
...
I drew the skybox using six squares. Move each square to proper location and change the normals at each vertex from perpendicular to the surface to shooting out from center of the skybox. Finally apply proper image to each side of the box and let the box rotate to get 360 degree of views.
